...
*** codeium
   #+begin_src emacs-lisp
     (custom-set-variables
      ...
      ;; NO IDEA HOW TO GET THE API KEY
      ;; see password manager for the current api key
      '(codeium/metadata/api_key "xxxx")
      ;; '(compilation-scroll-output 'first-error)
      '(warning-suppress-log-types '((comp))))

     (setq ms/codeium-activate t)
     (defun swap-codeium ()
       (interactive)
       (if ms/codeium-activate
           (setq ms/codeium-activate nil)
         (setq ms/codeium-activate t)))
     (evil-define-key 'normal 'lsp-mode-map (kbd "SPC l l") 'swap-codeium)

     (defun optional-codeium-cap ()
       (message "CODEIUM")
       (if ms/codeium-activate (codeium-completion-at-point) nil))
     ...
     (use-package codeium
         ...
         (add-hook 'python-mode-hook
     	  ...
     	  (add-to-list 'completion-at-point-functions #'optional-codeium-cap)))
         ;; (add-hook 'python-mode-hook
         ;;     (lambda ()
